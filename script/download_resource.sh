...
test -f res/image_file.jpg || echo "downloading Squeezenet model (3)"
test -f res/predict_net.pb || curl --progress-bar --output res/predict_net.pb https://s3.amazonaws.com/caffe2/models/squeezenet/predict_net.pb
test -f res/init_net.pb || curl --progress-bar --output res/init_net.pb https://s3.amazonaws.com/caffe2/models/squeezenet/init_net.pb
