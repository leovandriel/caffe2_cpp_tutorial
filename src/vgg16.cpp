...
CAFFE2_DEFINE_string(init_net, "res/vgg16_init_net.pb", "The given path to the init protobuffer.");
CAFFE2_DEFINE_string(predict_net, "res/vgg16_predict_net.pb", "The given path to the predict protobuffer.");
